...
const ChatUi = ({ isShown }) => {
  return (
    <div>
      ...
      :
      <div className="flex justify-center flex-col mt-[250px] ml-[250px] mb-[100px]">
      ...
      <div className="flex justify-center">
        <p className="font-semibold text-lg">Select a chat to view conversation</p>
      </div>
    </div>
      }
